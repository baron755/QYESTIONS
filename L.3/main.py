...
from main_edit import txt_Question, txt_Answer, txt_Wrong1, txt_Wrong2, txt_Wrong3
...
def testlist():
    ...
    frm = Question("Яблуко1", "apple", "apply", "pinaple", "pear")
    questions_listmodel.form_list.append(frm)
    frm = Question("Яблуко2", "apple", "apply", "pinaple", "pear")
    questions_listmodel.form_list.append(frm)
    frm = Question("Яблуко3", "apple", "apply", "pinaple", "pear")
    questions_listmodel.form_list.append(frm)
    frm = Question("Яблуко4", "apple", "apply", "pinaple", "pear")
    questions_listmodel.form_list.append(frm)
...
def show_random():
    ...
    frm_card = random_AnswerCheck(questions_listmodel,
                                  lb_Question, radio_list, lb_Correct, lb_Result)
    frm_card.show()
    show_question()
...
def set_main():
    ...
    win_main.setWindowTitle('Question list')
